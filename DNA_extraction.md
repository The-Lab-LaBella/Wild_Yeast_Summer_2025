...
Required Materials
-	0.4% trypan blue
-	2x 1.5ml microcentrifuge tube
-	Cell counter chamber

1.	Create a 1:2 dilution of your cells in a 1.5ml microcentrifuge tube
2.	Add 10 µL of trypan blue to a 1.5ml microcentrifuge tube 
3.	Add 10 µL of your cell suspension to the tube
4.	Mix the sample by pipetting up and down
5.	Gently add 10 µL of the sample to the cell counter chamber

6.	Leave the chamber on the bench for 30 seconds
7.	Insert slide into slide adapter until it clicks. The instrument reads one side of the slide at a time, so insert the sides appropriately.
8.	Select Rapid capture in the machine
9.	Record the Trypan Blue Corrected Total 
10.	 If the concentration is less than 1 × 104 or greater than 1 × 107 cells/mL, you will need to re-analyze your sample with a new dilution
...
1.	Add _______mLs (from above) of your cell culture to a pre-chilled 50-ml Falcon tube. 
2.	Add _______mLs (from above) of water to a 50-ml Falcon Tube for balance
3.	Centrifuge at 3,000g for 5 minutes at 4°C.
4.	Remove as much supernatant as possible and dispose of it into a container with 10% bleach
5.	Resuspend the pellet in 10 mL ice-cold PBS
6.	Centrifuge at 3,000g for 5 minutes at 4°C.
7.	Remove as much supernatant as possible and dispose of it into a container with 10% bleach
...
1.	Add 500 µL of Spheroplast Buffer to your yeast pellet
2.	Gently resuspend the pellet
3.	Transfer resuspended pellet to 1.5ml microcentrifuge tube
4.	Add 10 μl Zymolyase (5U/μ)] 
5.	Pipette up and down to mix with a wide-bore tip to mix.
6.	Incubate at 30°C for 20 minutes.  
7.	Invert and gently flick tubes every 5 minutes to keep cells suspended in solution.
8.	Gently pellet spheroplasts by centrifugation for 3 minutes at 300 x g
9.	Remove the supernatant.
10.	Using a 1000 µl wide-bore pipette tip, gently resuspend the spheroplast pellet in 200 µl of cold PBS.
...
-	g-DNA Wash Buffer
-	DNA Elution Buffer
-	1x Zymo-Spin column labeled with your code
-	2 Collection Tubes labeled with your code
-	1 microcentrifuge tube labeled with your code
